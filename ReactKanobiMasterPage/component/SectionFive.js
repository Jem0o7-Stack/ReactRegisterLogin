...
class SectionFive extends React.Component {
    render() {
        ...
        return (
            ...
            <section className="section hidden-xs" data-background-image="../public/images/banner_testimonial.jpg" data-shadow="" data-nav-color="#ffffff" data-nav-color-text="#d73e4d" data-color="" data-title-color="" data-title="Testimonials1" data-anchor="testimonials1" style={{ background: 'fixed' }}>
                <div className="section-content" data-appear-animation="fadeInLeft" data-appear-animation-delay="300">
                    <div className="container section-wrap" >
                        <div className="testimonials" data-options='{"singleItem": true}'>
