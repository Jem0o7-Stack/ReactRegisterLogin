...
//Form Stylization
	function formStylization(){
		...
		$(checkbox).wrap('<div class="new-checkbox"></div>').closest('.new-checkbox').append('<svg xmlns="../../../../../../../www.w3.org/2000/svg.html" xmlns:xlink="../../../../../../../www.w3.org/1999/xlink.html" width="18px" height="18px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve"><polygon fill="#fff" points="9.298,13.391 4.18,9.237 3,10.079 9.297,17 17.999,4.678 16.324,3 "/></svg>');
...
//Charts
	...
	function pieCharts(){
		...
		//Pie Chart 1
		if ($('#chart1').length){
			var data1 = [['One', 25],['Two', 15], ['Three', 16],Â ['Four', 17],['Five', 27]],
